...
import { getAvailabilityForShoot, getShootDetail, listStudios } from '@/lib/queries/lockup'
...
export default async function ShootDetailPage({ params }: { params: { id: string } }) {
  ...
  const [shoot, availability, myCapabilities, users, studios] = await Promise.all([
